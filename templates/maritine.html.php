  ...
  <div class="bg-white p-8 rounded-lg shadow-xl flex flex-row" id="modalContent largeur">
    ...
    <div class="w-1/2 pl-4">
      ...
      <div class="mt-4">
        ...
        <input type="text"  value="Senegal" id="country1" class="w-full border border-gray-300 rounded px-3 py-2 mb-4 focus:outline-none focus:border-blue-500">
        <label for="country2" class="block mb-2">Pays de destination :</label>
        <input type="text" id="country2" class="w-full border border-gray-300 rounded px-3 py-2 mb-4 focus:outline-none focus:border-blue-500">
        <button id="calculateMapDistance" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Calculer Distance</button>
        <p id="distanceOutput"  id="distance"  class="mt-2"></p>
      </div>
    </div>
  </div>
</div>
...
<script src="../template/public/"></script>
